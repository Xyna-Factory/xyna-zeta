 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
import { ChangeDetectionStrategy, Component, inject, Input, numberAttribute, output, viewChild } from '@angular/core';
...
export class XcGraphComponent {
    ...
    readonly resizeEmitter = output<any>({ alias: 'xc-graph-resize' });
