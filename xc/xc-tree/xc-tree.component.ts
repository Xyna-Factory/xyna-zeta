...
@Component({
    ...
    imports: [MatTree, XcI18nContextDirective, MatTreeNodeDef, MatNestedTreeNode, XcIconButtonComponent, MatTreeNodeToggle, XcTooltipDirective, NgClass, XcTemplateComponent, MatTreeNodeOutlet, XcI18nPipe]
})
